/*
  AWT 자바의 GUI API를 대부분 지원하기는 하지만, 플랫폼(os)마다 디자인이 일반적이지 않다는 문제점이 있다.
  이 부분을 해결하기 위해 swing api로 확장해서 GUI를 구현할 수 있다.
  swing에 대한 학습부담은 갖지 않아도 된다. 기존 우리가 알고있던 컴포넌트에 접두어로 J가 붙기 때문이다.
  swing은 기존의 AWT와 다르게 스윙만의 룩앤필(Look & Fell)이 있다.
     */
...
public class SwingTest extends JFrame{
	...
	// why? has a 란 부품을 보유한 관계이므로, 해당 본체가 태어날 때 같이 생성되어야 하므로
